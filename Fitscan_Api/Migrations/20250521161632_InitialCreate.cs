        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gymcode = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "FitnessTrackingDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Username = table.Column<string>(type: "text", nullable: true),
                    RecordedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    Biceps = table.Column<double>(type: "double precision", nullable: false),
                    Belly = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    Calf = table.Column<double>(type: "double precision", nullable: false),
                    Thighs = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FitnessTrackingDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Username = table.Column<string>(type: "text", nullable: true),
                    Gymcode = table.Column<string>(type: "text", nullable: true),
                    Userplanname = table.Column<string>(type: "text", nullable: true),
                    Userplanexpiry = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Active = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GymCode = table.Column<string>(type: "text", nullable: false),
                    Amount = table.Column<float>(type: "real", nullable: false),
